...
const Home: NextPage = ({ posts }: Props) => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <h1 className='py-5 font-bold text-xl'>Latest Articles</h1>
      <hr />
      ...
      <h1 className='py-5 font-bold text-xl'>Tutorials</h1>
      <hr />
      <div className="grid gris-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6 p-2 md:p-6">
        {tutorials.map((post) => {
          return (<Link key={post._id} href={`/post/${post.slug.current}`}>
      ...
      <hr />
      <footer className="text-center mt-10 bg-gray-900 text-white">
  <div className="container px-6 pt-6">
    <div className="flex justify-center mb-6">
      ...
      <a href="#!" type="button" className="rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-grey-400 hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
        <svg aria-hidden="true"
        focusable="false"
        data-prefix="fab"
        data-icon="github"
  ...
  <div className="text-center p-4 bg-blue-1000">
    © 2021 Copyright:
    <a className="text-whitehite" href="https://tailwind-elements.com/"> Market Watcher</a>
  </div>
</footer>
    </div>
